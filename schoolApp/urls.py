...
urlpatterns = [
    ...
    path('blog_detail/<str:slug>/', views.blogDetail, name = 'blog_detail'),    
    ...
    path('register/', views.visitorReg, name = 'register'), 
    path('login/', views.visitorLogin, name = 'login'), 
    path('userlogout/', views.VisitorLogout, name = 'userLogout'),
]
